 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = deg * PI / 180 + min * PI / (60 * 180) + sec * PI / (60 * 60 * 180)
 ...
 */
fun numberRevert(number: Int): Int =(number % 10) * 100 + (number / 100) + (number - (number % 10) - (number / 100) * 100)

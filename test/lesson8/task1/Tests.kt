...
class Tests {
    ...
    fun lineBySegment() {
        ...
        assertApproxEquals(Line(Point(0.0, 0.0), PI / 2), lineBySegment(Segment(Point(0.0, 0.0), Point(0.0, 1.0))))
        assertApproxEquals(
            Line(Point(2.0, 0.0), 0.0),
            lineBySegment(Segment(Point(2.0, 0.0), Point(4.0, 0.0)))
        )
        assertApproxEquals(
            Line(Point(0.22660437951788737, -5e-324), 0.0),
            lineBySegment(Segment(Point(0.22660437951788737, -5e-324), Point(0.0, 5e-324)))
        )
    }
